"""
Simple Strands Agent with search, weather, directions, local time, and FX tools.
...
def _create_agent() -> Agent:
    """
    Create and configure the Strands agent with all registered tools.

    Returns:
        Configured Agent instance
    """
    logger.info("Creating Strands agent with search, weather, directions, time, and FX tools")
...
def main() -> None:
    ...
    print("\n" + "=" * 80)
    print("Simple Agent: Search, Weather, Directions, Time, Exchange rates")
    print("=" * 80 + "\n")

    print("Ask me anything! Search, weather, directions, local time, and currency conversion.")
